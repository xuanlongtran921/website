...
const translations = {
  vi: {
    ...
    hero_card_left_badge: "ADVANCED AI INTEGRATION",
    hero_card_left_item1: "• Phễu chuyển đổi tự động hóa",
    hero_card_left_item2: "• Bảng so sánh đa sàn Real-time",
    hero_card_left_item3: "• Đo lường tỷ lệ Click (CTR) 4.2%",
    hero_card_left_roi: "ROI TĂNG +300%",
    hero_card_right_badge: "GLOBAL MARKET DEALS",
    hero_card_right_item1: "• Shopee Mall / LazMall",
    hero_card_right_item2: "• Amazon Associates Sync",
    hero_card_right_item3: "• Mã độc quyền: SMART20",
    hero_card_right_status: "4 SÀN LIÊN KẾT",
  ...
  en: {
    ...
    // Hero Mockup Floating Cards
    hero_card_left_badge: "ADVANCED AI INTEGRATION",
    hero_card_left_item1: "• Automated CRO Funnels",
    hero_card_left_item2: "• Real-time Multi-store Comparison",
    hero_card_left_item3: "• 4.2% Tracked Affiliate CTR",
    hero_card_left_roi: "+300% ROI SURGE",
    hero_card_right_badge: "GLOBAL MARKET DEALS",
    hero_card_right_item1: "• Amazon Associates & Best Buy",
    hero_card_right_item2: "• Instant Cookie Tracking Sync",
    hero_card_right_item3: "• Exclusive Coupon: SMART20",
    hero_card_right_status: "TOP 4 AFFILIATE PLATFORMS",
  ...
  zh: {
    ...
    // Hero Mockup Floating Cards
    hero_card_left_badge: "ADVANCED AI INTEGRATION",
    hero_card_left_item1: "• 自动化高转化漏斗",
    hero_card_left_item2: "• 实时多平台全网比价矩阵",
    hero_card_left_item3: "• 追踪点击率 (CTR) 达 4.2%",
    hero_card_left_roi: "ROI 提升 +300%",
    hero_card_right_badge: "GLOBAL MARKET DEALS",
    hero_card_right_item1: "• 亚马逊联盟 & 跨境精选",
    hero_card_right_item2: "• 全球返佣Cookie精准追踪",
    hero_card_right_item3: "• 专属立减券：SMART20",
    hero_card_right_status: "已打通 4 大电商平台",
